...
-----------------------------------------------------------------
./src/test/java/com.cassidian.cap/mymuleproject/MymuleprojectTestCase.java
...
description=Consumes CAP messages from NOAA and distrbutes them. POC.
muleVersion=3.2.0
packagePath=com/mycompany/mule
forgeProject=n
transports=file,http,jdbc,jms,vm
modules=client,cxf,management,scripting,sxc,xml,atom,ibeans

version=1.0-SNAPSHOT
groupId=com.cassidian.cap
basedir=/Users/enzoaquino/Projects
--------------------------------------------------------------------